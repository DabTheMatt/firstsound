...
/** Factory delays whose algorithm matches the inspector type. */
export function presetsForDelayType(type: DelayType): SpacePreset[] {
  return SPACE_PRESETS.filter((p) => p.kind === 'delay' && p.delayType === type)
}
