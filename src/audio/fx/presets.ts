...
export const SPACE_PRESETS: SpacePreset[] = [
  ...
  { id: 'rv-large-hall', name: 'Large Hall', kind: 'reverb', category: 'Hall', reverbType: 'largeHall', params: reverbP({ reverbSize: 78, reverbDecay: 4.2, reverbPredelay: 36, reverbWet: 30, reverbWidth: 160, reverbOffset: 28, reverbDiffusion: 74, reverbLowCut: 110 }) },
  { id: 'rv-cathedral', name: 'Cathedral', kind: 'reverb', category: 'Hall', reverbType: 'cathedral', params: reverbP({ reverbSize: 90, reverbDecay: 8, reverbPredelay: 56, reverbWet: 28, reverbDistance: 70, reverbWidth: 170, reverbOffset: 32, reverbInput: 0, reverbLowCut: 160, reverbHighCut: 9000, reverbDamping: 4200 }) },
  ...
  { id: 'rv-dreamy', name: 'Dreamy Cloud', kind: 'reverb', category: 'Ambient', reverbType: 'cloud', params: reverbP({ reverbSize: 80, reverbDecay: 7, reverbDiffusion: 86, reverbModDepth: 28, reverbWet: 28, reverbWidth: 165, reverbOffset: 28, reverbInput: 0, reverbLowCut: 140, reverbHighCut: 10000 }) },
  { id: 'rv-bloom', name: 'Bloom', kind: 'reverb', category: 'Ambient', reverbType: 'bloom', params: reverbP({ reverbSize: 78, reverbDecay: 6.5, reverbPredelay: 40, reverbDiffusion: 82, reverbWet: 28, reverbWidth: 160, reverbOffset: 24, reverbModDepth: 22, reverbInput: 0, reverbLowCut: 120 }) },
  { id: 'rv-shimmer', name: 'Shimmer', kind: 'reverb', category: 'Ambient', reverbType: 'shimmer', params: reverbP({ reverbSize: 72, reverbDecay: 5.5, reverbShimmer: 36, reverbShimmerPitch: 12, reverbWet: 26, reverbModDepth: 18, reverbWidth: 160, reverbOffset: 22, reverbInput: 0, reverbLowCut: 160, reverbHighCut: 11000 }) },
  { id: 'rv-cinema', name: 'Cinematic Tail', kind: 'reverb', category: 'Ambient', reverbType: 'largeHall', params: reverbP({ reverbSize: 88, reverbDecay: 8, reverbPredelay: 64, reverbDistance: 72, reverbWet: 28, reverbWidth: 170, reverbOffset: 32, reverbDiffusion: 76, reverbInput: 0, reverbLowCut: 150, reverbHighCut: 9500 }) },
  { id: 'rv-abyss', name: 'Abyss', kind: 'reverb', category: 'Ambient', reverbType: 'cathedral', params: reverbP({ reverbSize: 92, reverbDecay: 10, reverbPredelay: 80, reverbDistance: 78, reverbWet: 26, reverbWidth: 175, reverbOffset: 36, reverbDamping: 3200, reverbLowCut: 220, reverbHighCut: 6000, reverbInput: 0 }) },
  { id: 'rv-wash', name: 'Distant Wash', kind: 'reverb', category: 'Ambient', reverbType: 'hall', params: reverbP({ reverbSize: 82, reverbDecay: 6.5, reverbDistance: 80, reverbWet: 28, reverbLowCut: 280, reverbHighCut: 6000, reverbDamping: 4000, reverbWidth: 165, reverbOffset: 30, reverbInput: 0 }) },
  { id: 'rv-infinite', name: 'Infinite Pad', kind: 'reverb', category: 'Ambient', reverbType: 'infinite', params: reverbP({ reverbSize: 84, reverbDecay: 20, reverbFreeze: 1, reverbWet: 22, reverbShimmer: 10, reverbWidth: 155, reverbOffset: 16, reverbInput: 0, reverbLowCut: 180, reverbHighCut: 9000 }) },
  ...
  { id: 'rv-fifth', name: 'Fifth Shimmer', kind: 'reverb', category: 'Experimental', reverbType: 'shimmer', params: reverbP({ reverbSize: 70, reverbDecay: 5, reverbShimmer: 38, reverbShimmerPitch: 7, reverbWet: 24, reverbWidth: 155, reverbOffset: 20, reverbInput: 0, reverbLowCut: 150 }) },
  { id: 'rv-sub-shimmer', name: 'Sub Halo', kind: 'reverb', category: 'Experimental', reverbType: 'shimmer', params: reverbP({ reverbSize: 72, reverbDecay: 5.5, reverbShimmer: 28, reverbShimmerPitch: -12, reverbWet: 24, reverbWidth: 140, reverbInput: 0, reverbLowCut: 80, reverbHighCut: 7000, reverbDamping: 3500 }) },
