...
export const SPACE_PRESETS: SpacePreset[] = [
  ...
  { id: 'rv-mono', name: 'Mono Glue', kind: 'reverb', category: 'Stereo', reverbType: 'room', params: reverbP({ reverbSize: 30, reverbDecay: 0.7, reverbPredelay: 10, reverbWet: 30, reverbWidth: 0, reverbOffset: 0, reverbInput: 0, reverbStereo: 0, reverbModDepth: 0 }) },
