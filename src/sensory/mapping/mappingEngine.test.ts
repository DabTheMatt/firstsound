...
describe('interpolateMorphStop', () => {
  it('lerps numeric params between designed stops', () => {
    ...
    expect(mid.params?.reverbWet).toBeGreaterThan(10)
    expect(mid.params?.reverbWet).toBeLessThan(24)
  })
})
...
describe('mapSensoryToDsp', () => {
  ...
  it('space morphs reverb only from subtle to vast without 100% wet', () => {
    ...
    expect(subtle.params.reverbWet).toBeGreaterThan(5)
    expect(subtle.params.reverbWet).toBeLessThan(14)
    ...
    expect(vast.params.reverbDecay).toBeGreaterThan(2)
    ...
    expect(vast.params.reverbSize).toBeGreaterThan(60)
