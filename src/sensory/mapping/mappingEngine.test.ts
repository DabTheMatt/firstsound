...
describe('interpolateMorphStop', () => {
  it('lerps numeric params between designed stops', () => {
    ...
    expect(mid.params?.reverbWet).toBeGreaterThan(6)
    expect(mid.params?.reverbWet).toBeLessThan(14)
  })
})
...
describe('mapSensoryToDsp', () => {
  ...
  it('space morphs reverb only from subtle to vast without 100% wet', () => {
    ...
    expect(subtle.params.reverbWet).toBeGreaterThan(3)
    expect(subtle.params.reverbWet).toBeLessThan(10)
    ...
    expect(vast.params.reverbDecay).toBeGreaterThan(1)
    ...
    expect(vast.params.reverbEarly).toBeGreaterThan(50)
    expect(vast.params.reverbSize).toBeGreaterThan(50)
